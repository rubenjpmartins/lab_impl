...
print	"Mensagem para o servidor: " +	Input

# Recebe mensagem do servidor
(ServerMsg,	(ServerIP,	ServerPort))	=	ClientSock.recvfrom (1024)  
print	"Mensagem do servidor: 2 Estas registado!  "
...
while True:
	...
	if modo=="sender":
		...
		if flag==1:
			...
			print	("Mensagem para o servidor: " +	msg)
			(ServerMsg,	(ServerIP,	ServerPort))	=	ClientSock.recvfrom (1024)	
			print	("Mensagem do servidor: " +	ServerMsg)
			print "Adeus"
			ClientSock.close ()
			break	
		...
		ClientSock.sendto(msgtoserver,('localhost',	5005))
		print	("Mensagem do servidor: " + msgtoserver)
	...
	if modo =="receiver":
		...
		msgtoserver="5 Mensagem recebida no destinatario"
		ClientSock.sendto(msgtoserver,('localhost',	5005))
